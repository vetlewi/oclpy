...
class Matrix(AbstractArray):
    ...
    def plot(self, *, ax: Any = None,
        ...
        ax.set_xlabel(xtitle if xtitle is not None else r"$\gamma$-ray energy $E_{\gamma}$")
        ax.set_ylabel(ytitle if ytitle is not None else r"Excitation energy $E_{x}$")
